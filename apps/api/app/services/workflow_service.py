...
class WorkflowService:
    ...
    def _get_workflow_config(self, project_id: str) -> Dict:
        ...
        config_path = os.path.join(self.projects_dir, project_id, 'workflow_config.json')
        ...
        try:
            ...
            print(f"Error reading workflow config: {e}")
            return {"sections": []}
    ...
    def _get_results(self, project_id: str) -> Dict:
        ...
        results_path = os.path.join(self.projects_dir, project_id, 'output', 'results.json')
